const ArticlesRelatedLoadingSkeleton = ({ relatedArticles }) => {
  ...
  return (
    <div className="mb-12 min-w-[300px]">
      <h2 className="mb-4 text-xl font-bold text-gray-900 dark:text-white border-t-[0.5px] border-slate-700 pt-3">
        Related Articles
      </h2>
      ...
      {relatedArticles.map((item, index) => {
        ...
        return (
          <div key={index} className="mb-6 flex items-start cursor-pointer">
