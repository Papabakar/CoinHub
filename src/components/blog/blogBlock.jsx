...
function BlogPost({ data }) {
  ...
  return data.map((item) => {
    ...
    return (
      ...
      >
        <div className="rounded-t-3xl min-h-[300px] bg-center w-full bg-auto bg-no-repeat" style={{background: `url(${imageUrl})`, backgroundRepeat: 'no-repeat', backgroundPosition: 'center', backgroundSize: 'cover'}}>
